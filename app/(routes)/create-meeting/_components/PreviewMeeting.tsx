    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 mt-5">
        ...
        <div className="p-4 border-r">
          <h2>Business Name</h2>
          <h2 className="font-bold text-2xl">{formValue?.eventName ?? 'Meeting Name'}</h2>
          <div className="mt-5 flex flex-col gap-4">
            ...
            <Link href={formValue?.locationUrl ?? '#'} className="text-primary">{formValue?.locationUrl}</Link>
          </div>
        </div>
